...
const App = () => (
  <DesignCanvas defaultZoom={0.6}>
    ...
    <DCSection id="landing" title="★ Landing page · Bún" subtitle="V1 · BLUE + animation max — showcase">
      <DCArtboard id="landing-v1" label="V1 · Desktop · BLUE + animation max" width={1280} height={3500}>
        <BunLanding_v1 />
      </DCArtboard>
      <DCArtboard id="landing-mobile" label="Mobile · 402px (iPhone)" width={402} height={5400}>
        <BunLanding_mobile />
      </DCArtboard>
    </DCSection>

    {/* Mobile app screens */}
    <DCSection id="app-mobile" title="★ Web app · Mobile" subtitle="5 màn chính · bottom tab bar · 402px width · cùng tone với landing">
      <DCArtboard id="app-m-dashboard" label="01 · Dashboard" width={402} height={820}>
        <MDashboard />
      </DCArtboard>
      <DCArtboard id="app-m-flashcard" label="02 · Flashcard · Typing" width={402} height={820}>
        <MFlashcardTyping />
      </DCArtboard>
      <DCArtboard id="app-m-reveal" label="03 · Ôn tập · Reveal + rate" width={402} height={1080}>
        <MReveal />
      </DCArtboard>
      <DCArtboard id="app-m-decks" label="04 · Bộ từ" width={402} height={920}>
        <MDecksList />
      </DCArtboard>
      <DCArtboard id="app-m-add" label="05 · Thêm từ + AI auto-fill" width={402} height={1020}>
        <MAddWord />
      </DCArtboard>
      <DCArtboard id="app-m-dict" label="06 · Từ điển nhanh" width={402} height={920}>
        <MDictionary />
      </DCArtboard>
      <DCArtboard id="app-m-aloud" label="07 · Đọc to · mic + per-word" width={402} height={920}>
        <MReadAloud />
      </DCArtboard>
      <DCArtboard id="app-m-sentence" label="08 · Đặt câu · timer + AI chấm" width={402} height={900}>
        <MSentence />
      </DCArtboard>
      <DCArtboard id="app-m-article" label="09 · Bài đọc tương tác" width={402} height={1020}>
        <MArticle />
      </DCArtboard>
      <DCArtboard id="app-m-settings" label="10 · Cài đặt" width={402} height={1200}>
        <MSettings />
      </DCArtboard>
    </DCSection>
